										...
										<form name="schinfo_form" id="SettingsInfoForm" class="form-horizontal" method="post"  enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													...
													<img src="<?php if( !empty( $imglogo ) ) {echo $settings_data['sch_logo'];} ?>" id="image" class="img img-circle school-logo" width="150" height="150"/></div>
													...
													<a href="javascript:void(0);" style="padding:7px; <?php /*if(empty( $imglogo ) ) { ?> display:none; <?php } */?>" class="sch-remove-logo btn-danger btn">Remove</a>
